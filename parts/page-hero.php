...
<?php if ($thumbnail_image): ?>
    <section class="relative hero bg-cover bg-center w-full overflow-hidden h-[560px] md:h-auto md:min-h-[1024px] lg:min-h-fit bg-black/40 bg-blend-multiply <?php print is_front_page() ? 'lg:aspect-[18/13]' : 'lg:aspect-[36/19]'; ?>" style="background-image:url(<?php print $thumbnail_image?>)">
